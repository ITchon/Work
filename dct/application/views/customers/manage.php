            ...
            <div class="col-xs-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <h3>MANAGE CUSTOMERS <i class="fa fa-address-book"></i></h3>
                </div>
                <div class="card-body">
               ...
               echo "<tr>";
                ...
                echo "<td class='text-center'><a  data-toggle='tooltip' data-html='true' data-placement='bottom' aria-describedby='passHelp' title='<h5>แก้ไขข้อมูล</h5>' data-original-title='Rule' href='".base_url()."customers/edit/".$r->cus_id."'  ><i class='btn-info no-border fa fa-pencil-square-o'></i></a>";
