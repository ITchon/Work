<div class="layout-content">
        <div class="layout-content-body">
          ...
          <div class="row">
            ...
            <form class="table form form-horizontal container" action="<?php echo base_url()?>standard/update_v" method="post" data-toggle="validator" enctype="multipart/form-data">
