<div class="layout-content">
        ...
        <?php  
          ...
          <div class="row">
            ...
            <form class="form form-horizontal container" action="<?php echo base_url()."bom/insert_edit_part/$bm"?>" method="post" data-toggle="validator">
            <input type="hidden" name="m_id" value="<?php echo $m_id ?>">
            <div class="form-group">
                      <label for="email-2" class="col-sm-3 col-md-4 control-label">Main Part</label>      
                      <div class="col-sm-6 col-md-4">
                      <input type="text" class="form-control" name="p_no" value="<?php echo $p_no ?>" readonly>
                    </div>
                    </div> 
            <div class="form-group">
