            ...
            <form class="form form-horizontal container" action="<?php echo base_url()?>changepassword/changed_pass" method="post" data-toggle="validator">
	              ...
	              <div class="form-group has-feedback">
                   ...
                   <div class="form-group has-feedback">
                      ...
                      <div class="col-sm-6 col-md-3">
                      <input id="password" class="form-control" type="text" autocomplete="off" name="new_password" placeholder="Enter your New Password" required />
                      <span class="form-control-feedback" aria-hidden="true">
                      <span class="icon"></span>
                      </span>
                      </div>
                   ...
                   <div class="form-group has-feedback">
                      ...
                      <div class="col-sm-6 col-md-3">
                      <input id="password" class="form-control" type="text" autocomplete="off" name="con_password" placeholder="Enter your Confirm Password" required />
                      <span class="form-control-feedback" aria-hidden="true">
                      <span class="icon"></span>
                      </span>
                      </div>
