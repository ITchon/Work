            ...
            <form class="form form-horizontal container" action="<?php echo base_url()?>changepassword/changed_pass" method="post" data-toggle="validator">
	              ...
	              <div class="form-group has-feedback">
                   ...
                   <div class="form-group has-feedback">
                      ...
                      <div class="col-sm-6 col-md-3">
                      <input  class="form-control" type="password" autocomplete="off" name="cur_password" placeholder="Enter your Current Password" />
                      <span class="form-control-feedback" aria-hidden="true">
                      <span class="icon"></span>
                      </span>
                      </div>
                   ...
                   <div class="form-group has-feedback">
                      ...
                      <div class="col-sm-6 col-md-3">
                      <input  class="form-control" type="password" autocomplete="off" name="new_password" placeholder="Enter your New Password" />
                      <span class="form-control-feedback" aria-hidden="true">
                      <span class="icon"></span>
                      </span>
                      </div>
                   ...
                   <div class="form-group has-feedback">
                      ...
                      <div class="col-sm-6 col-md-3">
                      <input  class="form-control" type="password" autocomplete="off" name="con_password" placeholder="Enter your Confirm Password" />
                      <span class="form-control-feedback" aria-hidden="true">
                      <span class="icon"></span>
                      </span>
                      </div>
